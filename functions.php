<?php
	function js_portfolio(){
		...
		wp_enqueue_script('jquery', 'https://code.jquery.com/jquery-3.3.1.min.js', array(), null, 'all');
		...
		wp_enqueue_script('loader', get_template_directory_uri() . '/js/loader.js', array(), '1.0', true);
	}
